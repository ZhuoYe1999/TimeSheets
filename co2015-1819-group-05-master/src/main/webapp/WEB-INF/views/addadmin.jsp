...
<div class="add">
<label style="color: black;font-size: 33px; font-weight : bold;"> Add Admin: </label><br>
</div>
<div class="rectangle">
...
<div class="content">
		<form action="/addadmin/addadmin" method="Post"> 
		
		<input type ="text" name="users" placeholder="name.surname@fdmgroup.com"></input><br>
		<div class="submit">
		<input type="submit" value="Add" name="add" class="button"/> <br>
		</div>
		<br> <br> <br>	
   <p >Reminder: You can only add one new admin at a time.</p> 
		</form>
</div>
		</div>
		</div>
